---
name: pptx-design
description: org/beamer 발표자료(hackartist-new.sty 계열)를 같은 룩앤필의 편집 가능한 PowerPoint 로 변환한다. "org를 ppt로", "발표자료 pptx로 뽑아줘", "덱을 파워포인트로", "pptx 템플릿" 요청 시 사용. 표·다단·기능 아키텍처·AS-IS/TO-BE 도해까지 이미지가 아닌 네이티브 도형으로 생성한다.
---
...
- 커맨드 전체 레퍼런스: `reference/commands.md`
- 실제 사용 예: `notes/presentations/db-sto-02-offshore-rwa/make_pptx.py` (25장)
